...
//всплывающая подсказка в хедере
  ...
  function animate_1() {
    if($('.wrap-animate-1').hasClass('active')){
      $('.wrap-animate-1').find('span').addClass('span-animate')
      $('.wrap-animate-1').removeClass('active')
      $('.wrap-animate-1').fadeOut(8000,function () {
        $('.wrap-animate-2').fadeIn(500,function () {
          console.log('Привет')
        })
        $('.wrap-animate-2').addClass('active')
        $('.wrap-animate-2').find('span').addClass('span-animate')
        $('.wrap-animate-1').find('span').removeClass('span-animate')
      })
    }
    else{
  ...
  function addClass() {
    ...
    if($('.wrap-animate-1').hasClass('active')){
      ...
      $('.wrap-animate-1').removeClass('active')
      $('.wrap-animate-1').fadeOut(1000,function () {
        addClass2()
      })
      $('.wrap-animate-1').siblings('.wrap-animate-2').addClass('active')
    }
    else {
      $('.wrap-animate-1').addClass('active')
      $('.wrap-animate-1').fadeIn(1000)
      $('.wrap-animate-1').siblings('.wrap-animate-2').removeClass('active')
  ...
  // function addClass_2(){
  //   $('.wrap-animate-2').fadeIn(1000)
  //   $('.wrap-animate-2').find('span').addClass('span-animate')
  //
  // }
  // setTimeout(addClass_2,7500)
  ...
  function addClass2() {
    ...
    // if($('.wrap-animate-2').hasClass('active')){
      $('.wrap-animate-2').addClass('active')
      $('.wrap-animate-2').fadeIn(1000)
      $('.wrap-animate-2').find('span').addClass('span-animate')
      // $('.wrap-animate-2').siblings('.wrap-animate-1').addClass('active')
