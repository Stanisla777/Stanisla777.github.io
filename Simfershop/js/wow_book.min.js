...
c[f].toLowerCase(),this._controls[e]=d(this._controls[e]).add(a[c[f]]||a[e])},toggleControl:function(a,b){(a=this._controls[a.toLowerCase()])&&d(a).toggleClass("wowbook-disabled",b)},toolbarControls:{_default:"<a href='#'><i></i></a>",first:"<a title='На последнюю'><i></i></a>",back:"<a title='Назад'><i></i></a>",next:"<a title='Вперед'><i></i></a>",last:"<a title='Последняя страница'><i></i></a>",zoomin:"<a title='Приблизить'><i></i></a>",zoomout:"<a title='Отдалить'><i></i></a>",
slideshow:"<a title='Слайдшоу'><i></i></a>",flipsound:"<a title='Вкл/выкл. звук'><i></i></a>",fullscreen:"<a title='На весь экран'><i></i></a>",thumbnails:"<a title='Превью всех страниц'><i></i></a>",toc:"<a title='Открыть содержание'><i></i></a>",download:"<a title='download'><i></i></a>"},createToolbar:function(a,b){if(a&&(b=d(b||this.opts.toolbarParent||this.elem.parent()))&&b.length){var c=d('<div class="wowbook-toolbar">'),e=d('<div class="wowbook-controls">').appendTo(c);this.opts.toolbarIcons&&
